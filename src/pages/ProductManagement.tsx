...
const ProductManagement: React.FC = () => {
    ...
    const {
        ...
        apiMethod: productAPI.getAll,
        deleteMethod: productAPI.delete,
        toggleMethod: productAPI.edit,
        idField: 'productId',
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <Button onClick={() => navigate('/products/add')} className="h-12 px-6 rounded-2xl flex items-center gap-2">
                                        ...
                                        <tr key={product._id} className="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-colors group cursor-default">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-4">
                                                    <div className="h-14 w-14 rounded-2xl bg-slate-100 dark:bg-slate-800 overflow-hidden flex items-center justify-center border border-gray-100 dark:border-slate-700">
                                                        {product.image ? (
                                                            <Image
                                                                src={product.image}
                                                                alt={product.title}
                                ...
                                <div key={product._id} className="group bg-gray-50/50 dark:bg-slate-800/30 rounded-[32px] border border-gray-100 dark:border-slate-800 overflow-hidden hover:border-primary-500/30 transition-all flex flex-col h-full shadow-sm">
                                    <div className="relative aspect-square overflow-hidden bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800">
                                        ...
                                        <div className="absolute top-4 right-4 flex items-center gap-2">
                                            <button onClick={() => navigate(`/products/edit/${product._id}`)} className="p-3 bg-white/90 dark:bg-slate-900/90 backdrop-blur text-primary-600 rounded-2xl shadow-xl hover:bg-primary-600 hover:text-white transition-all shadow-sm"><Edit size={18} /></button>

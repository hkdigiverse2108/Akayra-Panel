            ...
            <Card className="rounded-3xl shadow-xl border-0 overflow-hidden bg-white dark:bg-slate-900 text-left">
                <div className="p-1 text-left">
                    <Form
                        ...
                        requiredMark={false}
                        className="max-w-2xl mx-auto py-8 text-left"
                    >
                        <div className="space-y-8 text-left">
                            ...
                            <Form.Item 
                                label={<span className="font-bold text-slate-600 dark:text-slate-400 text-left">Size Label (e.g., XL, 42, 10”)</span>} 
                                name="name" 
                            ...
                            >
                                <Input 
                                    ...
                                    className="h-12 rounded-xl border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-white uppercase focus:ring-primary-500 text-left" 
                                />
                            </Form.Item>
                        </div>

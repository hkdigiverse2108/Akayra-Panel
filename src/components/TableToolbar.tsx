...
const TableToolbar: React.FC<TableToolbarProps> = ({
    ...
    return (
        <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-gray-50/50 dark:bg-slate-800/20">
            <div className="flex flex-col md:flex-row items-center gap-6 flex-1">
                ...
                <div className="relative w-full md:w-96">
                    ...
                    <input
                        type="text"
                        className="block w-full pl-11 pr-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-2xl leading-5 text-slate-900 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent sm:text-sm transition-all shadow-sm font-medium"
                ...
                {showActiveFilter && onActiveFilterChange && (
                    <div className="flex items-center gap-3 bg-white dark:bg-slate-900 px-4 py-2 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm">

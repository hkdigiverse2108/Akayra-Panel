                ...
                <div className="p-1 text-left">
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                            ...
                            <Form.Item 
                                label={<span className="font-bold text-slate-600 dark:text-slate-400 text-left">Category Name</span>} 
                                name="name" 
                        ...
                        <div className="mt-12 flex items-center gap-4 border-t border-slate-100 dark:border-slate-800 pt-8 text-left">
                            <Button 
                                type="submit" 
                                loading={addCategory.isPending || editCategory.isPending || fetching}

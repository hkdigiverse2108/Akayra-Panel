                    ...
                    <div className="text-left overflow-hidden">
                        <Breadcrumb 
                            ...
                            items={[
                                ...
                                { title: <span className="cursor-pointer hover:text-primary-500 transition-colors" onClick={() => navigate(ROUTES.SIZES)}>Sizes</span> },
            ...
            <Card className="rounded-2xl sm:rounded-3xl shadow-xl border-0 overflow-hidden bg-white dark:bg-slate-900 text-left">
                <div className="p-0 sm:p-1 text-left">
                    <Form
                        ...
                        requiredMark={false}
                        className="max-w-2xl mx-auto p-5 sm:py-8 text-left"
                    >
                        <div className="space-y-6 sm:space-y-8 text-left">
                            ...
                            <Form.Item 
                                label={<span className="font-bold text-slate-600 dark:text-slate-400 text-sm sm:text-base text-left">Size Label (e.g., XL, 42, 10”)</span>} 
                                name="name" 
                            ...
                            >
                                <Input 
                                    ...
                                    className="h-10 sm:h-12 rounded-lg sm:rounded-xl border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-white uppercase focus:ring-primary-500 text-left" 
                                />
                            </Form.Item>
                        </div>
                        ...
                        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 border-t border-slate-100 dark:border-slate-800 pt-6 sm:pt-8 text-left">
                            <Button 
                                type="submit" 
                                loading={addSize.isPending || editSize.isPending || fetching}

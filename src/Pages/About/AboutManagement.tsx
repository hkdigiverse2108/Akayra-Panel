    ...
    <div className="space-y-4 sm:space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 text-left">
        <div className="text-left px-1">
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight">About Page Management</h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium mt-1 text-sm sm:text-base">Manage About sections, highlights, and priorities.</p>
        </div>
            ...
            <table className="w-full text-left border-collapse min-w-[900px] lg:min-w-full">
              <thead>
                <tr className="bg-gray-50/50 dark:bg-slate-800/30">
                  ...
                  <th className="px-4 sm:px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-gray-100 dark:border-slate-800">Description</th>
                  ...
                  aboutSections.map((section: any, index: number) => {
                    ...
                    return (
                      <tr key={sectionId || index} className="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-colors group cursor-default">
                        ...
                        <td className="px-4 sm:px-8 py-5">
                          <div className="flex items-center gap-3 sm:gap-4 text-left">
                            ...
                            <div className="text-left overflow-hidden">
                              <p className="text-sm font-black text-slate-900 dark:text-white leading-snug pb-0.5 truncate max-w-[220px] sm:max-w-xs">{getTitle(section)}</p>
                              <p className="text-[10px] font-bold text-slate-400 mt-1 truncate max-w-[220px] sm:max-w-xs">{getSubtitle(section)}</p>
                        ...
                        <td className="px-4 sm:px-8 py-5">
                          <p className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-400 line-clamp-2 max-w-[320px]">{getDescription(section)}</p>
                        </td>
                        <td className="px-4 sm:px-8 py-5">
                ...
                return (
                  <div key={sectionId || index} className="group relative bg-gray-50/50 dark:bg-slate-800/30 rounded-3xl border border-gray-100 dark:border-slate-800 overflow-hidden hover:border-primary-500/30 transition-all flex flex-col p-4 shadow-sm">
                    ...
                    <div className="flex items-start justify-between gap-3 text-left">
                      ...
                      <div className={cn("px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest", isActive(section) ? "text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10" : "text-slate-400 bg-slate-100 dark:bg-slate-800")}>{isActive(section) ? "Active" : "Inactive"}</div>
                    </div>

                    <p className="mt-3 text-xs font-medium text-slate-600 dark:text-slate-400 line-clamp-3">{getDescription(section)}</p>

    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3 text-left">
        ...
        <div className="text-left">
          <h2 className="text-lg sm:text-xl font-black text-slate-900 dark:text-white tracking-tight text-left">Account Settings</h2>
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Manage your profile details and contact information.</p>
        </div>
      </div>
      ...
      <Form layout="vertical" requiredMark={false} form={form} initialValues={initialValues} onFinish={onFinish} className="text-left">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left">
          ...
          <Form.Item
            label={<span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">Email Address</span>}
            name="email"
            className="text-left"
            rules={[
  ...
  const passwordTab = (
    <div className="space-y-6">
      <div className="flex items-center gap-3 text-left">
        ...
        <div className="text-left">
          <h2 className="text-lg font-black text-slate-900 dark:text-white tracking-tight text-left">Change Password</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400">Keep a strong password to secure your account.</p>
        </div>
      </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left">
          ...
          <Form.Item
            label={<span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">New Password</span>}
            name="newPassword"
            className="text-left"
            rules={[
          ...
          <Form.Item
            label={<span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">Confirm Password</span>}

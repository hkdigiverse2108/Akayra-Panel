            ...
            <Card className="rounded-2xl sm:rounded-3xl shadow-xl border-0 overflow-hidden bg-white dark:bg-slate-900 text-left">
                <div className="p-0 sm:p-1 text-left">
                    <Form
                        ...
                        requiredMark={false}
                        className="max-w-4xl mx-auto p-5 sm:py-8 text-left"
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 text-left">
                            ...
                            <Form.Item 
                                label={<span className="font-bold text-slate-600 dark:text-slate-400 text-sm sm:text-base text-left">Brand Name</span>} 
                                name="name" 
                            ...
                            <Form.Item 
                                label={<span className="font-bold text-slate-600 dark:text-slate-400 text-sm sm:text-base text-left">Logo/Image URL</span>} 
                                name="image" 
                                className="col-span-2 md:col-span-1 text-left mb-4 sm:mb-6"
                            >

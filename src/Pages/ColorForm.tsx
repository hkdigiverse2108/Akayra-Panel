            ...
            <Card className="rounded-2xl sm:rounded-3xl shadow-xl border-0 overflow-hidden bg-white dark:bg-slate-900 text-left">
                <div className="p-0 sm:p-1 text-left">
                    <Form
                        ...
                        requiredMark={false}
                        className="max-w-3xl mx-auto p-5 sm:py-8 text-left"
                    >
                        <div className="space-y-6 sm:space-y-8 text-left">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-start text-left">
                                <div className="space-y-4 sm:space-y-6 text-left">
                                    <Form.Item 
                                        label={<span className="font-bold text-slate-600 dark:text-slate-400 text-sm sm:text-base text-left">Color Name</span>} 
                                        name="name" 
                                    ...
                                    >
                                        <div className="flex gap-2 sm:gap-3 text-left">
                                            ...
                                            >
                                                <div 
                                                    className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg sm:rounded-xl border-2 border-white dark:border-slate-700 shadow-sm cursor-pointer hover:scale-105 transition-transform active:scale-95"
                                ...
                                <div className="bg-slate-50 dark:bg-slate-800/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 flex flex-col items-center justify-center border border-slate-100 dark:border-slate-800 min-h-[160px] sm:min-h-[220px] text-center">
                                    <div 
                                        className="h-16 w-16 sm:h-24 sm:w-24 rounded-full shadow-2xl ring-4 ring-white dark:ring-slate-700 transition-all duration-300"
                                        style={{ backgroundColor: hexCodeValue }}
                                    />
                                    <p className="mt-4 font-black text-slate-900 dark:text-white tracking-widest uppercase text-center text-sm sm:text-base">
                        ...
                        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 border-t border-slate-100 dark:border-slate-800 pt-6 sm:pt-8 text-left">
                            <Button 
                                ...
                                className="h-12 sm:h-14 px-10 rounded-xl sm:rounded-2xl font-black sm:text-lg bg-primary-600 hover:bg-primary-700 border-0 flex items-center justify-center gap-2 shadow-lg shadow-primary-500/20 w-full sm:w-auto"
                            >
                            ...
                            <Button 
                                variant="ghost" 
                                onClick={() => navigate(ROUTES.COLORS)}
                                className="h-12 sm:h-14 px-8 rounded-xl sm:rounded-2xl font-bold border-2 text-slate-600 hover:bg-slate-50 w-full sm:w-auto"
                            >
                                Cancel
                            </Button>
                        </div>

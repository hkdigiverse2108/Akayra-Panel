                ...
                <div key={blog._id} className="group relative bg-gray-50/50 dark:bg-slate-800/30 rounded-[2rem] border border-gray-100 dark:border-slate-800 overflow-hidden hover:border-primary-500/30 transition-all flex flex-col h-full shadow-sm">
                  <div className="aspect-square w-full bg-white dark:bg-slate-900 overflow-hidden border-b border-gray-50 dark:border-slate-800 relative">
                    ...
                    <div className="absolute top-4 right-4 flex items-center gap-2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                      <button onClick={() => navigate(`${ROUTES.BLOGS}/edit/${blog._id}`)} className="h-10 w-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur text-primary-600 rounded-xl shadow-xl flex items-center justify-center hover:bg-primary-600 hover:text-white transition-all">
                        <Edit size={16} />
                      </button>
                      <button onClick={() => handleDeleteClick(blog._id)} className="h-10 w-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur text-red-600 rounded-xl shadow-xl flex items-center justify-center hover:bg-red-600 hover:text-white transition-all">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>

        ...
        <Form.Item
          ...
          label={
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest text-left">
              <span className="text-red-500 mr-1">*</span> PRODUCT TITLE
            </span>
          }
    ...
    <Card className="rounded-[32px] border-0 shadow-xl overflow-hidden p-8 text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
        <Form.Item
          ...
          label={
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest text-left">
              <span className="text-red-500 mr-1">*</span> MRP (MAX PRICE)
            </span>
          }
        ...
        <Form.Item
          ...
          label={
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest text-left">
              <span className="text-red-500 mr-1">*</span> SELLING PRICE
            </span>
          }
            ...
            <div className="rounded-2xl border border-gray-100 dark:border-slate-800 bg-gray-50/60 dark:bg-slate-900/40 p-4 overflow-visible">
              {watchedThumbnail ? (
                <div className="h-24 w-24 sm:h-28 sm:w-28 rounded-2xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-center overflow-hidden relative group/cover">
                  ...
                  <button type="button" onClick={() => form.setFieldsValue({ thumbnail: "" })} className="absolute -top-0 -right-0 h-7 w-7 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-red-600 flex items-center justify-center shadow-md" aria-label="Remove cover">
                    <X size={16} />
                  </button>
                </div>
              ) : (
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">No cover selected</div>
              )}
            </div>
          </div>
        </Form.Item>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-gray-100 dark:border-slate-800 bg-gray-50/60 dark:bg-slate-900/40 p-4 overflow-visible">
              {galleryImages.length > 0 ? (
                ...
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">No images selected</div>
              )}
            </div>
          </div>
        </Form.Item>
    ...
    <Card className="rounded-[32px] border-0 shadow-xl overflow-hidden p-8 bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 text-left">
      ...
      <div className="space-y-6 text-left">
        <Form.Item
          name="categoryId"
          label={
            <span className="text-[10px] font-black text-slate-400 dark:text-white/40 uppercase tracking-widest text-left">
    ...
    <div className="max-w-7xl mx-auto space-y-4 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 px-4 sm:px-0 pb-12 sm:pb-0 text-left">
          ...
          <div className="text-left overflow-hidden">
            <Breadcrumb
              ...
              items={[
                ...
                {
                  title: (
                    <span className="cursor-pointer hover:text-primary-500 transition-colors" onClick={() => navigate(ROUTES.PRODUCTS)}>
                      Products
                    </span>
                  ),
                },
            ...
            />
            <h1 className="text-xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight text-left truncate">{isEditMode ? "Edit Product" : "New Product"}</h1>
          </div>
        </div>
        <div className="flex items-center gap-2 sm:gap-3">
          <Button variant="ghost" onClick={() => navigate(ROUTES.PRODUCTS)} className="h-10 sm:h-12 px-4 sm:px-6 rounded-xl sm:rounded-2xl border-2 font-bold text-slate-600 dark:text-slate-400 flex-1 sm:flex-none">
            Cancel
          </Button>
      ...
      <UploadImage
        ...
        onSelect={(items: UploadItem[]) => {
          ...
          const merged = Array.from(new Set([...galleryImages, ...urls]));
          form.setFieldsValue({ images: merged });
        }}
      />

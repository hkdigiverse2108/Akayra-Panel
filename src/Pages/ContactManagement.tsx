...
const ContactManagement: React.FC = () => {
  ...
  const { items: inquiries, loading, total, currentPage, pageSize, searchTerm, setSearchTerm, setCurrentPage, setPageSize, } = useManagementData({ resourceKey: KEYS.CONTACT.ALL, resourceUrl: URL_KEYS.CONTACT.ALL, dataKey: 'contact_data', useActiveFilter: false,   });
  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-in fade-in duration-500">
      ...
      <Card className="!p-0 overflow-hidden rounded-2xl sm:rounded-3xl shadow-xl border-0 bg-white dark:bg-slate-900">
        <TableToolbar searchTerm={searchTerm} onSearchChange={setSearchTerm} placeholder="Search inquiries..." showActiveFilter={false} />

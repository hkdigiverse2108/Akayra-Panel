              ...
              return (
                <div key={item.label} className="space-y-1">
                  <button
                    ...
                    className={cn(
                      'flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-all group outline-none',
                      isParentActive && !isOpen ? 'bg-primary-500/10 text-primary-400' : 'hover:bg-slate-800 text-slate-400 hover:text-white'
                    )}
                  >
                        ...
                        <NavLink
                          ...
                          className={({ isActive }) =>
                            cn(
                              ...
                              isActive ? 'bg-primary-500/10 text-primary-400 font-bold' : 'text-slate-500 hover:text-slate-300 hover:bg-slate-800/50'
                            )
                          }
                        >
